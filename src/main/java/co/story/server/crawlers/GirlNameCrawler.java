...
@Crawler(name = "name_woman")
public class GirlNameCrawler extends BaseSeimiCrawler {
    ...
    public String[] startUrls() {
        return new String[]{"http://xh.5156edu.com/xm/nu.html"};
    }

    @Override
    public void start(Response response) {
        try {
            FileOutputStream out = new FileOutputStream("name_girl.sql");
    ...
    public void getWords(Response response) {
        ...
        try {
            ...
            String sql = String.format("INSERT INTO name_build (gender,word_key,words) VALUES (1,'%s','%s');", key, content);
